...
title = tk.Label(text="Click below to capture a live picture for testing disease....", background="lightgreen",
                 fg="Brown", font=("", 15))
title.grid()
...
def openphoto():
    ...
    fileName = 'live_picture.jpg'
    dst = "testpicture"  # Change the destination directory according to your setup
    ...
    title.destroy()
    button1.destroy()
    button2 = tk.Button(text="Analyse Image", command=analyze_image)
    button2.grid(column=0, row=2, padx=10, pady=10)


button1 = tk.Button(text="Capture Photo", command=capture_photo)
